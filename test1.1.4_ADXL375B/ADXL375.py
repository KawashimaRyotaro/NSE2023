...
class ADXL375Dev:
  ...
  def accel(self):
    ...
    if xAccl >= 0b1000000000000000:
      xAccl -= 1
      xAccl = xAccl ^ 0b1111111111111111
      xAccl = ~xAccl
    
    yAccl = (data[3] << 8) | data[2]
    if yAccl >= 0b1000000000000000:
      yAccl -= 1
      yAccl = yAccl ^ 0b1111111111111111
      yAccl = ~yAccl
      
    zAccl = (data[5] << 8) | data[4]
    if zAccl >= 0b1000000000000000:
      zAccl -= 1
      zAccl = zAccl ^ 0b1111111111111111
      zAccl = ~zAccl
